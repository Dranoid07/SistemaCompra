...
@NamedQueries({
    ...
    , @NamedQuery(name = "UnidadesMedida.findByEstado", query = "SELECT u FROM UnidadesMedida u WHERE u.estado = :estado")})
public class UnidadesMedida implements Serializable {
    ...
    public UnidadesMedida(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "com.entity.UnidadesMedida[ id=" + id + " ]";
    }
